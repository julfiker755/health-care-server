...
const deleteIntoBD = (id) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const adminInfo = yield prisma_1.default.admin.findUniqueOrThrow({
        where: { id },
    });
    if (!!((_a = adminInfo.profilePhoto) === null || _a === void 0 ? void 0 : _a.length)) {
        fileUploader_1.fileUploader.deleteFile(adminInfo.profilePhoto);
    }
    const result = yield prisma_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
        const adminDeleteInfo = yield tx.admin.delete({
...
const softDeleteBD = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
        const adminDeleteInfo = yield tx.admin.update({
            where: { id: adminInfo.id },
            data: { isDeleted: true },
        });
...
const updateProfileBD = (user, file, data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (((_a = adminInfo.profilePhoto) === null || _a === void 0 ? void 0 : _a.length) && ((_b = file === null || file === void 0 ? void 0 : file.filename) === null || _b === void 0 ? void 0 : _b.length)) {
        fileUploader_1.fileUploader.deleteFile(adminInfo.profilePhoto);
    }
