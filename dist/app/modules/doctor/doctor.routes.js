...
router.get("/my-schedule/collect", (0, auth_1.default)(client_1.userRole.SUPER_ADMIN, client_1.userRole.DOCTOR), doctor_controller_1.doctorController.scheduleGetBD);
router.post("/schedule-store", (0, auth_1.default)(client_1.userRole.SUPER_ADMIN, client_1.userRole.DOCTOR), doctor_controller_1.doctorController.scheduleStoreBD);
router.delete("/schedule/remove/:id", (0, auth_1.default)(client_1.userRole.SUPER_ADMIN, client_1.userRole.DOCTOR), doctor_controller_1.doctorController.scheduleDeleteBD);
